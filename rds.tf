...
# Option Group
# -----------------------------------------------------------------------------
resource "aws_db_option_group" "mysql_standalone_op" {
  name                 = "${var.project}-${var.environment}-mysql-standalone-op"
  engine_name          = "mysql"
...
resource "aws_db_subnet_group" "mysql_standalone_subnetgroup" {
  name       = "${var.project}-${var.environment}-mysql-standalone-sbg"
...
resource "aws_db_instance" "mysql-standalone" {
  ...
  option_group_name    = aws_db_option_group.mysql_standalone_op.name
